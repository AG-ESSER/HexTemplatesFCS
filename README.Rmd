...
With the discrete approach we can make the weights between hexagons depend on the ranked distance between them.
```{r}
...
This way we can also use functions to create more complicated dependencies if needed.
```{r}
