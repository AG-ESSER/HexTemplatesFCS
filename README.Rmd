...
Plot the differences between two levels (index 2). Use *drop = F* to show plot title.
```{r}
...
The plot and plot_tscores functions return ggplot objects and are therefore highly customizable. They use geom_sf internally to display the hexagons. Additional arguments passed to geom_sf can be added in the function call.
